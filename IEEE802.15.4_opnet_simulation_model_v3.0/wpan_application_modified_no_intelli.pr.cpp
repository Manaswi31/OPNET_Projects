/* Process model C++ form file: wpan_application_modified_no_intelli.pr.cpp */
/* Portions of this file copyright 2014 by Riverbed Technology. All rights reserved. */


/*
 =========================== NOTE ==========================
 This file is automatically generated from wpan_application_modified_no_intelli.pr.m
...
const char wpan_application_modified_no_intelli_pr_cpp [] = "MIL_3_Tfile_Hdr_ 1800 30A modeler 7 571ECCD5 571ECCD5 1 volta chaganti 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 468d 2                                                                                                                                                                                                                                                                                                                                                                                                           ";
#include <string.h>
...
static int rand_int(int lowLimit, int upLimit);
...
int OUT_OF_NORMAL_DATA_BP;
int OUT_OF_NORMAL_DATA_HR;
int OUT_OF_NORMAL_DATA_SPO2;
int OUT_OF_NORMAL_DATA_Temp;
int OUT_OF_NORMAL_DATA_BS;
...
int heartRateNode[160] = {60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							...
							70,70,70,70,70,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70};
int spo2Node[75] = {50,120,60,130,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,130,120,130,130,50,50,50,50,50,120,50,120,60,50,50,50,50,50,50,120,50,60,60,50,50,50,50,50,50,50,50,50,50,50,50,50,
					50,120,60,130,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130};
...
/*int bloodPressureNode[200] = {183,180,180,187,156,180,194,210,180,180,175,172,180,175,200,180,180,180,180,180,180,180,180,180,180,180,180,175,180,180,180,180,180,180,175,180,180,180,180,180,
							183,180,180,187,156,180,194,210,180,180,175,172,180,175,200,180,180,180,180,180,180,180,180,180,180,180,180,175,180,180,180,180,180,180,175,180,180,180,180,180,
							183,180,180,187,156,180,194,210,180,180,175,172,180,175,200,180,180,180,180,180,180,180,180,180,180,180,180,175,180,180,180,180,180,180,175,180,180,180,180,180,
							183,180,180,187,156,180,194,210,180,180,175,172,180,175,200,180,180,180,180,180,180,180,180,180,180,180,180,175,180,180,180,180,180,180,175,180,180,180,180,180,
							183,180,180,187,156,180,194,210,180,180,175,172,180,175,200,180,180,180,180,180,180,180,180,180,180,180,180,175,180,180,180,180,180,180,175,180,180,180,180,180};
int heartRateNode[400] = {60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							70,70,70,70,70,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							70,70,70,70,70,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,
							60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120};
int spo2Node[170] = {50,120,60,130,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,130,120,130,130,50,50,50,50,50,120,50,120,60,50,50,50,50,50,50,120,
						50,60,60,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,130,120,130,130,120,120,120,50,120,60,130,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,
						50,120,60,130,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,130,120,130,130,50,50,50,50,50,120,50,120,60,50,50,50,50,50,50,120,
						50,60,60,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,120,60,130,130,130,130,130,120,130,130,120,130,130,120,120,120};
int bloodSugarNode[160] = {110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,
							110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,
							110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,
							110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150,110,110,110,140,140,150,150,140,150,150};
int temperatureNode[100] = {36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,
								36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38,36,37,36,36,38,36,38,38,38,38}; */
float bloodPressureNode[1000] = {0};
float heartRateNode[1000]={0};
float spo2Node[300]={0};
float bloodSugarNode[500]={0};
float temperatureNode[400]={0};
...
int valueNode4 = 0;
int valueNode5 = 0;
int counter1 = 0, counter2 = 0, sendCounter = 0, counter3 = 0, counter4 = 0, counter5 = 0;
...
class wpan_application_modified_no_intelli_state
	{
	private:
	...
	public:
		wpan_application_modified_no_intelli_state (void);
		...
		/* FSM code */
		void wpan_application_modified_no_intelli (OP_SIM_CONTEXT_ARG_OPT);
		/* Diagnostic Block */
		void _op_wpan_application_modified_no_intelli_diag (OP_SIM_CONTEXT_ARG_OPT);
...
VosT_Obtype wpan_application_modified_no_intelli_state::obtype = (VosT_Obtype)OPC_NIL;

#define pr_state_ptr            		((wpan_application_modified_no_intelli_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))
...
#define FIN_PREAMBLE_DEC	wpan_application_modified_no_intelli_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((wpan_application_modified_no_intelli_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
static void wpan_appl_init() {
	...
	/* Load the distributions into appropirate arrays */
	
	i = 0;
	fp = fopen("/home/chaganti/op_models/ZigBee/bloodPressure.txt", "r+");
	while(fscanf(fp,"%f ",&bloodPressureNode[i]) == 1)  
{  
       i++; 
}  
	   fclose(fp); i = 0;
	   
	   	fp = fopen("/home/chaganti/op_models/ZigBee/heartRate.txt", "r+");
	while(fscanf(fp,"%f ",&heartRateNode[i]) == 1)  
{     
	i++; 
}  
	   fclose(fp); i =0;
	   
	 fp = fopen("/home/chaganti/op_models/ZigBee/SPO2.txt", "r+");
	while(fscanf(fp,"%f ",&spo2Node[i]) == 1)  
{  
       i++; 
}  
	   fclose(fp); i = 0;
	   
	   	fp = fopen("/home/chaganti/op_models/ZigBee/temperature.txt", "r+");
	while(fscanf(fp,"%f ",&temperatureNode[i]) == 1)  
{  
       i++; 
}  
	   fclose(fp); i = 0;
	   
	   	fp = fopen("/home/chaganti/op_models/ZigBee/bloodSugar.txt", "r+");
	while(fscanf(fp,"%f ",&bloodSugarNode[i]) == 1)  
{  
       i++; 
}  
	   fclose(fp); 
	...
	payload_sent_stathandle			= op_stat_reg ("Application.Pay load value sent at node ",			OPC_STAT_INDEX_NONE, OPC_STAT_LOCAL);
...
static void wpan_be_packet_generate() {
	...
	op_pk_nfd_set_int32 (packet_NSDU_ptr, "nodeID", nodeName);
	op_pk_nfd_set_dbl (packet_NSDU_ptr, "payload", payLoad);
	...
	/*if (prg_string_order_case_insensitive(device_name,"Blood Pressure") == 0){
		...
		next_intarr_time = floor(op_dist_uniform (20));
		wpan_process_payload();
		}
		
	else if (prg_string_order_case_insensitive(device_name, "Blood Sugar") == 0){
		next_intarr_time = floor(op_dist_uniform (25));
		wpan_process_payload();
		} */
...
//	fuzzyptr = fuzzyGroup;
	...
	/* Copy contents into a different array to write stat handle */
/*	for(count = 0; count < 6 ; count ++)
	{ 
		strcpy(fuzzyCheckPtr[count].nodeName,fuzzyGroup[count].nodeName);
		fuzzyCheckPtr[count].payLoad = fuzzyGroup[count].payLoad;
...
/*	op_pk_nfd_get_int32(packet_NSDU_ptr, "nodeID", &nodeName);
	op_pk_nfd_get_dbl(packet_NSDU_ptr, "payload", &payLoad);
	
	printf("Node name at sender : %d, payload : %f\n",nodeName, payLoad); */
	...
	//if(OUT_OF_NORMAL_DATA_BP | OUT_OF_NORMAL_DATA_HR | OUT_OF_NORMAL_DATA_SPO2| OUT_OF_NORMAL_DATA_Temp | OUT_OF_NORMAL_DATA_BS | sendCounter){
	printf("OUT_OF_NORMAL_DATA_BP : %d OUT_OF_NORMAL_DATA_HR : %d OUT_OF_NORMAL_DATA_SPO2: %d OUT_OF_NORMAL_DATA_Temp : %d OUT_OF_NORMAL_DATA_BS: %d \n", 
		OUT_OF_NORMAL_DATA_BP, OUT_OF_NORMAL_DATA_HR,OUT_OF_NORMAL_DATA_SPO2,OUT_OF_NORMAL_DATA_Temp,OUT_OF_NORMAL_DATA_BS );
		op_pk_send (packet_MSDU_ptr, STRM_FROM_APPL_TO_NWK);
		printf("***OUT OF NORMAL DETECTED ****\n");
	//	if (prg_string_order_case_insensitive(device_name, fuzzyCheckPtr[Index].nodeName) == 0){
					op_stat_write(payload_sent_stathandle,payLoad);
		
	/*	for(Index = 0 ; Index < 6 ; Index ++){
		
			if (prg_string_order_case_insensitive(device_name, fuzzyCheckPtr[Index].nodeName) == 0){
					op_stat_write(payload_sent_stathandle,fuzzyCheckPtr[Index].payLoad);
	...
	//else{
	//		printf("Normal range detected : %s\n", device_name);
	//		packetsDiscarded++;
	//	}
	...
	//printf("MSDU : %d NSDU : %d\n", msdu_size, nsdu_size_print);
...
if(device_node == 0){
	...
	counter1++;		
	   ...
	   printf("Out of normal BP detected \n");
	   OUT_OF_NORMAL_DATA_BP = 1;
	   }
	   if(counter1 == 60){
			sendCounter = 1;
			counter1 = 0;
	...
	//else if (prg_string_order_case_insensitive(device_name,"Heart Rate") == 0){
	else if(device_node == 1){
		 nodeName = 1;
		 printf("Value node 2 : %d\n", valueNode2); 
		 printf("Errored out : %f \n", heartRateNode[2]);
		payLoad = heartRateNode[valueNode2];
		 printf("Payload : %f\n", payLoad);
		//payLoad = rand_int(45,125);
	   ...
	   printf("Out of normal HR detected \n");
	   OUT_OF_NORMAL_DATA_HR = 1;
	   }
		  if(counter2 == 60){
			sendCounter = 1;
			counter2 = 0;
	...
	//else if (prg_string_order_case_insensitive(device_name, "SPO2") == 0){
		else if(device_node == 4){
		 nodeName = 2;
		 printf("Errored out \n");
		payLoad = spo2Node[valueNode3];
		  printf("Payload : %f\n", payLoad);
		//payLoad = rand_int(80,120);
	   ...
	   printf("Out of normal SPO2 detected \n");
	   OUT_OF_NORMAL_DATA_SPO2 = 1;
	   }
		  if(counter3 == 60){
			sendCounter = 1;
			counter3 = 0;
	...
	//else if (prg_string_order_case_insensitive(device_name, "Temperature") == 0){
			else if(device_node == 2){
		 nodeName = 3;
		 printf("Errored out \n");
		payLoad = temperatureNode[valueNode4];
		  printf("Payload : %f\n", payLoad);
		 
	  //payLoad = rand_int(34,39);
	   ...
	   printf("Out of normal Temp detected \n");
	   OUT_OF_NORMAL_DATA_Temp = 1;
	   }
		  if(counter4 == 60){
			sendCounter = 1;
			counter4 = 0;
 ...
 * Function:	rand_int()
 *
 * Description:	Process to generate a random number in range lowLimit and upLimit
 *
 * Low limti and Up Limit
 *--------------------------------------------------------------------------------*/
...
//	srand(time(NULL));
	num = 	rand()%(upLimit-lowLimit)+lowLimit;	
...
extern "C"
{
	VosT_Obtype _op_wpan_application_modified_no_intelli_init (int * init_block_ptr);
	VosT_Address _op_wpan_application_modified_no_intelli_alloc (VosT_Obtype, int);
	void wpan_application_modified_no_intelli (OP_SIM_CONTEXT_ARG_OPT)
		{
		((wpan_application_modified_no_intelli_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))->wpan_application_modified_no_intelli (OP_SIM_CONTEXT_PTR_OPT);
		}

	void _op_wpan_application_modified_no_intelli_svar (void *, const char *, void **);

	void _op_wpan_application_modified_no_intelli_diag (OP_SIM_CONTEXT_ARG_OPT)
		{
		((wpan_application_modified_no_intelli_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))->_op_wpan_application_modified_no_intelli_diag (OP_SIM_CONTEXT_PTR_OPT);
		}

	void _op_wpan_application_modified_no_intelli_terminate (OP_SIM_CONTEXT_ARG_OPT)
		{
		/* The destructor is the Termination Block */
		delete (wpan_application_modified_no_intelli_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr);
		}
...
void
wpan_application_modified_no_intelli_state::wpan_application_modified_no_intelli (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (wpan_application_modified_no_intelli_state::wpan_application_modified_no_intelli ());
	try
		{


		FSM_ENTER ("wpan_application_modified_no_intelli")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "wpan_application_modified_no_intelli [init enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [init enter execs]", state0_enter_exec)
				{
				/* Initialization */
				wpan_appl_init ();
				}
			...
			FSM_STATE_EXIT_FORCED (0, "init", "wpan_application_modified_no_intelli [init exit execs]")


			/** state (init) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "idle", "tr_1", "wpan_application_modified_no_intelli [init -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (idle) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "idle", state1_enter_exec, "wpan_application_modified_no_intelli [idle enter execs]")

			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (3,"wpan_application_modified_no_intelli")


			/** state (idle) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "idle", "wpan_application_modified_no_intelli [idle exit execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [idle exit execs]", state1_exit_exec)
				{
			...
			FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [idle trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 2, state2_enter_exec, ;, "SEND_BE", "", "idle", "send BE", "send best-effort packet", "wpan_application_modified_no_intelli [idle -> send BE : SEND_BE / ]")
				FSM_CASE_TRANSIT (1, 3, state3_enter_exec, ;, "SEND_RT", "", "idle", "send RT", "send real-time packet", "wpan_application_modified_no_intelli [idle -> send RT : SEND_RT / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "RECEIVE_PCK", "", "idle", "receive pck", "receive packet from NWK", "wpan_application_modified_no_intelli [idle -> receive pck : RECEIVE_PCK / ]")
				FSM_CASE_TRANSIT (3, 1, state1_enter_exec, ;, "default", "", "idle", "idle", "tr_13", "wpan_application_modified_no_intelli [idle -> idle : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "send BE", state2_enter_exec, "wpan_application_modified_no_intelli [send BE enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [send BE enter execs]", state2_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (2, "send BE", "wpan_application_modified_no_intelli [send BE exit execs]")


			/** state (send BE) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send BE", "idle", "tr_6", "wpan_application_modified_no_intelli [send BE -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (send RT) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "send RT", state3_enter_exec, "wpan_application_modified_no_intelli [send RT enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [send RT enter execs]", state3_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (3, "send RT", "wpan_application_modified_no_intelli [send RT exit execs]")


			/** state (send RT) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send RT", "idle", "tr_8", "wpan_application_modified_no_intelli [send RT -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (receive pck) enter executives **/
			FSM_STATE_ENTER_FORCED (4, "receive pck", state4_enter_exec, "wpan_application_modified_no_intelli [receive pck enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified_no_intelli [receive pck enter execs]", state4_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (4, "receive pck", "wpan_application_modified_no_intelli [receive pck exit execs]")


			/** state (receive pck) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "receive pck", "idle", "tr_10", "wpan_application_modified_no_intelli [receive pck -> idle : default / ]")
				/*---------------------------------------------------------*/
		...
		FSM_EXIT (0,"wpan_application_modified_no_intelli")
		}
	catch (...)
		{
		Vos_Error_Print (VOSC_ERROR_ABORT,
			(const char *)VOSC_NIL,
			"Unhandled C++ exception in process model (wpan_application_modified_no_intelli)",
...
void
wpan_application_modified_no_intelli_state::_op_wpan_application_modified_no_intelli_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}

void
wpan_application_modified_no_intelli_state::operator delete (void* ptr)
	{
	FIN (wpan_application_modified_no_intelli_state::operator delete (ptr));
	Vos_Poolmem_Dealloc (ptr);
	FOUT
	}

wpan_application_modified_no_intelli_state::~wpan_application_modified_no_intelli_state (void)
	{

	FIN (wpan_application_modified_no_intelli_state::~wpan_application_modified_no_intelli_state ())
...
void *
wpan_application_modified_no_intelli_state::operator new (size_t)
#if defined (VOSD_NEW_BAD_ALLOC)
	...
	FIN_MT (wpan_application_modified_no_intelli_state::operator new ());

	new_ptr = Vos_Alloc_Object (wpan_application_modified_no_intelli_state::obtype);
#if defined (VOSD_NEW_BAD_ALLOC)
...
wpan_application_modified_no_intelli_state::wpan_application_modified_no_intelli_state (void) :
		_op_current_block (0)
	{
		...
		_op_current_state = "wpan_application_modified_no_intelli [init enter execs]";
#endif
	}

VosT_Obtype
_op_wpan_application_modified_no_intelli_init (int * init_block_ptr)
	{
	FIN_MT (_op_wpan_application_modified_no_intelli_init (init_block_ptr))

	wpan_application_modified_no_intelli_state::obtype = Vos_Define_Object_Prstate ("proc state vars (wpan_application_modified_no_intelli)",
		sizeof (wpan_application_modified_no_intelli_state));
	*init_block_ptr = 0;

	FRET (wpan_application_modified_no_intelli_state::obtype)
	}

VosT_Address
_op_wpan_application_modified_no_intelli_alloc (VosT_Obtype, int)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	wpan_application_modified_no_intelli_state * ptr;
	FIN_MT (_op_wpan_application_modified_no_intelli_alloc ())

	/* New instance will have FSM handling initialized */
#if defined (VOSD_NEW_BAD_ALLOC)
	try {
		ptr = new wpan_application_modified_no_intelli_state;
...
void
_op_wpan_application_modified_no_intelli_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	wpan_application_modified_no_intelli_state		*prs_ptr;

	FIN_MT (_op_wpan_application_modified_no_intelli_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (wpan_application_modified_no_intelli_state *)gen_ptr;
