/* Process model C form file: wpan_application_modified_no_intelli.pr.c */
...
const char wpan_application_modified_no_intelli_pr_c [] = "MIL_3_Tfile_Hdr_ 1800 30A modeler 7 57225901 57225901 1 volta chaganti 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 468d 2                                                                                                                                                                                                                                                                                                                                                                                                           ";
#include <string.h>
...
typedef struct
	...
	int	                    		nodeName                                        ;
	int	                    		device_node                                     ;
	Stathandle	             		bitssec_sent_be_MSDU_gstathandle                ;
	} wpan_application_modified_no_intelli_state;
...
#define bitssec_sent_be_MSDU_gstathandle		pr_state_ptr->bitssec_sent_be_MSDU_gstathandle
...
static void wpan_appl_init() {
	...
	i = 0;
	fp = fopen("/home/chaganti/op_models/ZigBee/BPtest2.txt", "r+");
	while(fscanf(fp,"%f ",&bloodPressureNode[i]) == 1)  
{  
printf("Blood Pressure Node : %f\n", bloodPressureNode[i]);     
i++; 
}  
	   fclose(fp); i = 0;
	   
	   	fp = fopen("/home/chaganti/op_models/ZigBee/HRtest2.txt", "r+");
...
{     
	i++; 
	 ...
	 fp = fopen("/home/chaganti/op_models/ZigBee/SPO2test2.txt", "r+");
...
{  
	   ...
	   fclose(fp); i = 0;
	   	...
	   	fp = fopen("/home/chaganti/op_models/ZigBee/Temptest2.txt", "r+");
...
{  
	   ...
	   fclose(fp); i = 0;
	   	...
	   	fp = fopen("/home/chaganti/op_models/ZigBee/BStest2.txt", "r+");
...
{  
	...
	bitssec_sent_be_MSDU_gstathandle	= op_stat_reg ("Application.Traffic Sent - best-effort MSDU (bits/sec)",		OPC_STAT_INDEX_NONE, OPC_STAT_LOCAL);
...
/*	op_pk_nfd_get_int32(packet_NSDU_ptr, "nodeID", &nodeName);
	...
	op_stat_write (bitssec_sent_be_MSDU_gstathandle, msdu_size);
	op_stat_write (bitssec_sent_be_MSDU_gstathandle, 0.0);
...
void
wpan_application_modified_no_intelli (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (wpan_application_modified_no_intelli ());
...
void
_op_wpan_application_modified_no_intelli_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_wpan_application_modified_no_intelli_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_wpan_application_modified_no_intelli_terminate ())
...
/* local variable prs_ptr in _op_wpan_application_modified_no_intelli_svar function. */
#undef self_id
#undef parent_id
#undef device_mode
#undef device_name
...
#undef nodeName
#undef device_node
#undef bitssec_sent_be_MSDU_gstathandle
...
_op_wpan_application_modified_no_intelli_init (int * init_block_ptr)
	...
	obtype = Vos_Define_Object_Prstate ("proc state vars (wpan_application_modified_no_intelli)",
...
VosT_Address
_op_wpan_application_modified_no_intelli_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	wpan_application_modified_no_intelli_state * ptr;
	FIN_MT (_op_wpan_application_modified_no_intelli_alloc (obtype))

	ptr = (wpan_application_modified_no_intelli_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "wpan_application_modified_no_intelli [init enter execs]";
#endif
		}
...
_op_wpan_application_modified_no_intelli_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	...
	if (strcmp ("bitssec_sent_be_MSDU_gstathandle" , var_name) == 0)
		{
		*var_p_ptr = (void *) (&prs_ptr->bitssec_sent_be_MSDU_gstathandle);
		FOUT
		}
	*var_p_ptr = (void *)OPC_NIL;
