/* Process model C form file: wpan_application_modified.pr.c */
/* Portions of this file copyright 2014 by Riverbed Technology. All rights reserved. */


/*
 =========================== NOTE ==========================
 This file is automatically generated from wpan_application_modified.pr.m
...
const char wpan_application_modified_pr_c [] = "MIL_3_Tfile_Hdr_ 1800 30A modeler 7 57228B5C 57228B5C 1 volta chaganti 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 468d 2                                                                                                                                                                                                                                                                                                                                                                                                           ";
#include <string.h>
...
typedef struct
	...
	} wpan_application_modified_state;

#define pr_state_ptr            		((wpan_application_modified_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))
...
#define FIN_PREAMBLE_DEC	wpan_application_modified_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((wpan_application_modified_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
/*	i = 0;
	fp = fopen("/home/chaganti/op_models/ZigBee/BPtest1.txt", "r+");
...
i++; 
	   ...
	   fclose(fp); i = 0;
	   	...
	   	fp = fopen("/home/chaganti/op_models/ZigBee/HRtest1.txt", "r+");
...
{     
	i++; 
	 ...
	 fp = fopen("/home/chaganti/op_models/ZigBee/SPO2test1.txt", "r+");
...
{  
	   ...
	   fclose(fp); i = 0;
	   	...
	   	fp = fopen("/home/chaganti/op_models/ZigBee/Temptest1.txt", "r+");
...
{  
	   ...
	   fclose(fp); i = 0;
	   	...
	   	fp = fopen("/home/chaganti/op_models/ZigBee/BStest1.txt", "r+");
...
/*	op_pk_nfd_get_int32(packet_NSDU_ptr, "nodeID", &nodeName);
	...
	printf("OUT_OF_NORMAL_DATA_BP : %d OUT_OF_NORMAL_DATA_HR : %d OUT_OF_NORMAL_DATA_SPO2: %d OUT_OF_NORMAL_DATA_Temp : %d OUT_OF_NORMAL_DATA_BS: %d sendCounter : %d \n", 
		OUT_OF_NORMAL_DATA_BP, OUT_OF_NORMAL_DATA_HR,OUT_OF_NORMAL_DATA_SPO2,OUT_OF_NORMAL_DATA_Temp,OUT_OF_NORMAL_DATA_BS, sendCounter );
...
if(device_node == 0){
       nodeName = 0;
		//payLoad = bloodPressureNode[valueNode1];
	   	   payLoad = rand_int(70,250);
	   		   //fp = fopen("/home/chaganti/op_models/ZigBee/bloodPressure.txt", "a+");
	  // fprintf(fp, "%f ", payLoad);
	  // fclose(fp);
	...
	//fp = fopen("/home/chaganti/op_models/ZigBee/heartRate.txt", "a+");
	//   fprintf(fp, "%f ", payLoad);
	  // fclose(fp); 
	...
	//else if (prg_string_order_case_insensitive(device_name, "SPO2") == 0){
		...
		//  	   fp = fopen("/home/chaganti/op_models/ZigBee/SPO2.txt", "a+");
	  // fprintf(fp,"%f ",payLoad);
	   //fclose(fp);
	...
	//	payLoad = temperatureNode[valueNode4];
	  ...
	  payLoad = rand_int(34,39);
		 	//	 	   fp = fopen("/home/chaganti/op_models/ZigBee/temperature.txt", "a+");
	//   fprintf(fp, "%f ",payLoad);
//		 fclose(fp);
	...
	//else if (prg_string_order_case_insensitive(device_name, "Blood Sugar") == 0){
		...
		// 		 	   fp = fopen("/home/chaganti/op_models/ZigBee/bloodSugar.txt", "a+");
	   //fprintf(fp, "%f ", payLoad);
		 //fclose(fp);
	   ...
	   printf("Out of normal BS detected \n");
...
extern "C" {
#endif
	void wpan_application_modified (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_wpan_application_modified_init (int * init_block_ptr);
	void _op_wpan_application_modified_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_wpan_application_modified_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_wpan_application_modified_alloc (VosT_Obtype, int);
	void _op_wpan_application_modified_svar (void *, const char *, void **);
...
void
wpan_application_modified (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (wpan_application_modified ());

		{


		FSM_ENTER ("wpan_application_modified")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "wpan_application_modified [init enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified [init enter execs]", state0_enter_exec)
				{
				/* Initialization */
				wpan_appl_init ();
				}
			...
			FSM_STATE_EXIT_FORCED (0, "init", "wpan_application_modified [init exit execs]")


			/** state (init) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "idle", "tr_1", "wpan_application_modified [init -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (idle) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "idle", state1_enter_exec, "wpan_application_modified [idle enter execs]")

			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (3,"wpan_application_modified")


			/** state (idle) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "idle", "wpan_application_modified [idle exit execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified [idle exit execs]", state1_exit_exec)
				{
			...
			FSM_PROFILE_SECTION_IN ("wpan_application_modified [idle trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 2, state2_enter_exec, ;, "SEND_BE", "", "idle", "send BE", "send best-effort packet", "wpan_application_modified [idle -> send BE : SEND_BE / ]")
				FSM_CASE_TRANSIT (1, 3, state3_enter_exec, ;, "SEND_RT", "", "idle", "send RT", "send real-time packet", "wpan_application_modified [idle -> send RT : SEND_RT / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "RECEIVE_PCK", "", "idle", "receive pck", "receive packet from NWK", "wpan_application_modified [idle -> receive pck : RECEIVE_PCK / ]")
				FSM_CASE_TRANSIT (3, 1, state1_enter_exec, ;, "default", "", "idle", "idle", "tr_13", "wpan_application_modified [idle -> idle : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "send BE", state2_enter_exec, "wpan_application_modified [send BE enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified [send BE enter execs]", state2_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (2, "send BE", "wpan_application_modified [send BE exit execs]")


			/** state (send BE) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send BE", "idle", "tr_6", "wpan_application_modified [send BE -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (send RT) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "send RT", state3_enter_exec, "wpan_application_modified [send RT enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified [send RT enter execs]", state3_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (3, "send RT", "wpan_application_modified [send RT exit execs]")


			/** state (send RT) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send RT", "idle", "tr_8", "wpan_application_modified [send RT -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (receive pck) enter executives **/
			FSM_STATE_ENTER_FORCED (4, "receive pck", state4_enter_exec, "wpan_application_modified [receive pck enter execs]")
				FSM_PROFILE_SECTION_IN ("wpan_application_modified [receive pck enter execs]", state4_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (4, "receive pck", "wpan_application_modified [receive pck exit execs]")


			/** state (receive pck) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "receive pck", "idle", "tr_10", "wpan_application_modified [receive pck -> idle : default / ]")
				/*---------------------------------------------------------*/
		...
		FSM_EXIT (0,"wpan_application_modified")
		}
	}
...
void
_op_wpan_application_modified_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_wpan_application_modified_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_wpan_application_modified_terminate ())
...
/* local variable prs_ptr in _op_wpan_application_modified_svar function. */
#undef self_id
#undef parent_id
#undef device_mode
#undef device_name
...
VosT_Obtype
_op_wpan_application_modified_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_wpan_application_modified_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (wpan_application_modified)",
		sizeof (wpan_application_modified_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_wpan_application_modified_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	wpan_application_modified_state * ptr;
	FIN_MT (_op_wpan_application_modified_alloc (obtype))

	ptr = (wpan_application_modified_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "wpan_application_modified [init enter execs]";
#endif
		}
...
void
_op_wpan_application_modified_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	wpan_application_modified_state		*prs_ptr;

	FIN_MT (_op_wpan_application_modified_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (wpan_application_modified_state *)gen_ptr;
