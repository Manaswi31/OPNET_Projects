/* Process model C++ form file: wpan_application_modified.pr.cpp */
...
const char wpan_application_modified_pr_cpp [] = "MIL_3_Tfile_Hdr_ 1800 30A modeler 7 5507853A 5507853A 1 rhel04 chaganti 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 468d 2                                                                                                                                                                                                                                                                                                                                                                                                          ";
#include <string.h>
...
int heartRateNode[160] = {60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,
							...
							70,70,70,70,70,60,70,80,80,90,60,70,60,60,70,120,120,60,70,70,70,70,70,70,120,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70};
int spo2Node[10] = {50,120,60,130,50,50,50,50,50,120};
int bloodSugarNode[10] = {110,110,110,140,140,150,150,140,150,150};
int temperatureNode[10] = {37,37,37,37,38,38,38,38,38,38};
int valueNode1 = 0;
int valueNode2 = 0;
int valueNode3 = 0;
int valueNode4 = 0;
...
class wpan_application_modified_state
	{
	private:
	...
	public:
		wpan_application_modified_state (void);
...
VosT_Obtype wpan_application_modified_state::obtype = (VosT_Obtype)OPC_NIL;
...
#define payload_sent_stathandle 		op_sv_ptr->payload_sent_stathandle
...
extern "C"
{
	...
	void wpan_application_modified (OP_SIM_CONTEXT_ARG_OPT)
		{
		((wpan_application_modified_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))->wpan_application_modified (OP_SIM_CONTEXT_PTR_OPT);
		}
	...
	void _op_wpan_application_modified_diag (OP_SIM_CONTEXT_ARG_OPT)
		{
		((wpan_application_modified_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))->_op_wpan_application_modified_diag (OP_SIM_CONTEXT_PTR_OPT);
		}

	void _op_wpan_application_modified_terminate (OP_SIM_CONTEXT_ARG_OPT)
		{
		/* The destructor is the Termination Block */
		delete (wpan_application_modified_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr);
		}
...
void
wpan_application_modified_state::wpan_application_modified (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (wpan_application_modified_state::wpan_application_modified ());
	try
		{
		...
		Vos_Error_Print (VOSC_ERROR_ABORT,
			(const char *)VOSC_NIL,
			"Unhandled C++ exception in process model (wpan_application_modified)",
...
void
wpan_application_modified_state::_op_wpan_application_modified_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}

void
wpan_application_modified_state::operator delete (void* ptr)
	{
	FIN (wpan_application_modified_state::operator delete (ptr));
	Vos_Poolmem_Dealloc (ptr);
	FOUT
	}

wpan_application_modified_state::~wpan_application_modified_state (void)
	{

	FIN (wpan_application_modified_state::~wpan_application_modified_state ())
...
void *
wpan_application_modified_state::operator new (size_t)
#if defined (VOSD_NEW_BAD_ALLOC)
	...
	FIN_MT (wpan_application_modified_state::operator new ());

	new_ptr = Vos_Alloc_Object (wpan_application_modified_state::obtype);
#if defined (VOSD_NEW_BAD_ALLOC)
...
wpan_application_modified_state::wpan_application_modified_state (void) :
		_op_current_block (0)
	{
		...
		_op_current_state = "wpan_application_modified [init enter execs]";
#endif
	}
...
_op_wpan_application_modified_init (int * init_block_ptr)
	...
	wpan_application_modified_state::obtype = Vos_Define_Object_Prstate ("proc state vars (wpan_application_modified)",
		sizeof (wpan_application_modified_state));
	*init_block_ptr = 0;

	FRET (wpan_application_modified_state::obtype)
	}

VosT_Address
_op_wpan_application_modified_alloc (VosT_Obtype, int)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	wpan_application_modified_state * ptr;
	FIN_MT (_op_wpan_application_modified_alloc ())

	/* New instance will have FSM handling initialized */
#if defined (VOSD_NEW_BAD_ALLOC)
	try {
		ptr = new wpan_application_modified_state;
